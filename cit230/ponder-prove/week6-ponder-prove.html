...
<html>
    <head>
        ...
        <title>week6-ponder-prove</title>
		<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/swfobject/2.2/swfobject.js"></script>
        <script type="text/javascript">swfobject.embedSWF("video/bird.swf", "bird", "400", "300", "8.0.0");</script>
    </head>
    <body>
        <header>
        ...
        <nav>
            ...
            <li><a href="rock-foods.html">Foods Using Rocks</a></li>
            ...
            <li><a href="../../cit230-links.html">CIT230-links</a></li>
        </nav>
        <br>
        <main>
            ...
            <figure>
                <img src="images/rock-love.jpg" alt="Viewing rocks" title="Enjoy Rocks" hight="150" width="125"/>
                <figcaption>Rocks are great to view from a ship!</figcaption>
            </figure>
        ...
        <br>
            ...
            <p> This Browser doesn not support our audio format.</p>
